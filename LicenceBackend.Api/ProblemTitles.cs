...
internal static class ProblemTitles
{
    ...
    public const string MixedCurrencyCart = "mixed_currency_cart";
    public const string CheckoutAttemptNotFound = "checkout_attempt_not_found";
    public const string EmptyOrder = "empty_order";
    public const string InvalidQuantity = "invalid_quantity";
    public const string LabelTooLong = "label_too_long";
    public const string LabelCountMismatch = "label_count_mismatch";
    public const string InvalidContactEmail = "invalid_contact_email";
